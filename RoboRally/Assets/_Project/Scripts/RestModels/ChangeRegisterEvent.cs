...
namespace Tgm.Roborally.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ChangeRegisterEvent")]
    public partial class ChangeRegisterEvent : IEquatable<ChangeRegisterEvent>, IValidatableObject
    {
        ...
        public ChangeRegisterEvent(ActionEnum action = default(ActionEnum), int card = default(int), int register = default(int))
        {
            this.Action = action;
        ...
        [DataMember(Name = "register", IsRequired = true, EmitDefaultValue = false)]
